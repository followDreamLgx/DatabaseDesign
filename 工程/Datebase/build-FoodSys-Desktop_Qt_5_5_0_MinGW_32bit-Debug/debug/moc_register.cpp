...
QT_MOC_LITERAL(4, 27, 21), // "on_SureButton_clicked"
QT_MOC_LITERAL(5, 49, 23), // "on_ReturnButton_clicked"
QT_MOC_LITERAL(6, 73, 23) // "on_UpdateButton_clicked"

    },
    "Register\0display\0\0indexNum\0"
    "on_SureButton_clicked\0on_ReturnButton_clicked\0"
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Register::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Register::display)) {
                *result = 0;
            }
        }
    }
...
void *Register::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "BaseImformation"))
        return static_cast< BaseImformation*>(const_cast< Register*>(this));
